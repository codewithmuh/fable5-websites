...
const cfg = {
  ...
  hero: {
    spotlight: {
      base: pin.airline.hero,
      baseFilter: 'brightness(.3) saturate(.45)',
    },
    line1: 'Chase the light',
    line2: 'above the clouds',
    leftText: 'Every Skyline window is a moving picture: an ocean of cloud at golden hour, a sunrise you will never describe properly to anyone back home.',
    sub: 'Move your cursor across the sky — your spotlight finds the light. That is what flying east with us feels like.',
    cta1: 'Book a flight',
    btnColor: '#1a1230',
  },
