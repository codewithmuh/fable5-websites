...
const cfg = {
  ...
  hero: {
    spotlight: {
      base: pin.jewelry.hero,
      baseFilter: 'brightness(.35) saturate(.5)',
    },
    line1: 'Light,',
    line2: 'made eternal',
    leftText: "Each Aurelle stone is cut over nine months by a single master's hands — then set in gold that will outlive every promise it seals.",
    sub: 'Let your cursor catch the stone — that flash is fifty-seven facets returning the light. Private viewings by appointment.',
    cta1: 'Book a private viewing',
    btnColor: '#241c0c',
  },
